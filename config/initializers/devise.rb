...
Devise.setup do |config|
  ...
  # secret key.
  # config.secret_key =
  # 'c1c995467677fe9c7f56d5c27f01e31c4faad4ecd105bb1646e8786c5b3
  #  9f58f452d47a49b658bf53e2ff49b56f4fab8c26646070ba8867f526345
  #  8fdc6d8cf8'
  ...
  config.mailer_sender = 'change-at-cfg-initializers-devise@example.com'
  ...
  # determining whether or not authentication should be aborted when the
  ...
  # be passed to the find_for_authentication method and considered in your
  # model lookup. For instance, if you set :request_keys to [:subdomain],
  ...
  # for the given strategies, for example, `config.params_authenticatable
  ...
  # Note that, for bcrypt (the default encryptor), the cost increases
  ...
  # config.pepper =
  # '6c5dd3647da5a607bc129496ec43063eadb0d40494b81b8549c4225e395
  #  7f4488f82b0a8393cd781133228023abab438d3bf8f92b0f2abf46b88d4
  #  ba3c6b3bd4'

  # ==> Configuration for :confirmable
  # A period that the user is allowed to access the website even without
  # confirming their account. For instance, if set to 2.days, the user will
  # be able to access the website for two days without confirming their
  # account, access will be blocked just in the third day. Default is
  # 0.days, meaning the user cannot access the website without confirming
  # their account.
  ...
  # way as initial account confirmation) to be applied. Requires additional
  # unconfirmed_email db field (see migrations). Until confirmed, new
  # email is stored in unconfirmed_email column, and copied to email
  ...
  # The time you want to timeout the user session without activity. After
  # this time the user will be asked for credentials again. Default is 30
  # minutes.
  ...
  # Allow you to use another encryption algorithm besides bcrypt
  # (default). You can use :sha1, :sha512 or encryptors from others
  # authentication tools as :clearance_sha1, :authlogic_sha512 (then you
  # should set stretches above to 20 for default behavior)
  ...
  # bcrypt config.encryptor = :sha512
  ...
  # engine is mountable, there are some extra configurations to be taken
  # into account. The following options are available, assuming the engine
  # is mounted as:
  #
